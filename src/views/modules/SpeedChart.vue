<template>
  <chart-card-layout class="chart" :title="`测点速度（${props.monitoringName}）`">
    <template #extra>
      <div class="date-type">
        <div>
...
import { getSpeedinfo } from "@/api/slope";
...
onMounted(() => {
  ...
  myChart = echarts.init(document.getElementById("speedLineChart"));
  myChart.setOption(option);
